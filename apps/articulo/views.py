...
def lista_articulos(request):
    ...
    for articulo in articulos:
        ...
        if request.user.is_authenticated:
            can_edit = es_colaborador_o_admin(request.user)
...
def detalle_articulo(request, pk):
    ...
    for comentario in comentarios:
        ...
        if user.is_authenticated:
            if (
                comentario.usuario == user or
                es_colaborador_o_admin(user)
            ):
                can_manage = True
...
# ----------------------------------------------------
#   CREAR ARTÍCULO (SOLO COLABORADOR / ADMIN)
# ----------------------------------------------------

@login_required
def crear_articulo(request):

    if not es_colaborador_o_admin(request.user):
        raise PermissionDenied("No tenés permiso para crear artículos.")
...
# ----------------------------------------------------
#   EDITAR ARTÍCULO (SOLO COLABORADOR / ADMIN)
# ----------------------------------------------------
...
def editar_articulo(request, pk):
    ...
    if not es_colaborador_o_admin(request.user):
        raise PermissionDenied("No tenés permiso para editar artículos.")
...
# ----------------------------------------------------
#   ELIMINAR ARTÍCULO (SOLO COLABORADOR / ADMIN)
# ----------------------------------------------------
...
def eliminar_articulo(request, pk):
    ...
    if not es_colaborador_o_admin(request.user):
        raise PermissionDenied("No tenés permiso para eliminar artículos.")
